...
class S3Manager():
    ...
    def list_files(self, bucket_name, folder=""):
        """
        List files in an S3 bucket under an optional prefix.

        Args:
            bucket_name (str): The name of the bucket.
            prefix (str): Optional folder prefix (e.g., '20250523/').
        ...
        object_keys = []
        try:
            print(f"Listing files in bucket '{bucket_name}' under prefix '{folder}'...")
            ...
            elif code == "AllAccessDisabled":
                print("Error: Access to the bucket is disabled!")
            else:
    ...
    def get_file_bytes(self, bucket_name: str, key: str) -> bytes:
        """Return raw binary content of an S3 file, suitable for PDFs."""
        try:
